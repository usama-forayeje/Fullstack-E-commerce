...
function FeaturedProducts({ featuredProducts }) {
  ...
  const handleNext = () => {
    setCurrentIndex((prevIndex) => (prevIndex + itemPerPage) % featuredProducts.length);
  };

  const handlePrev = () => {
    setCurrentIndex(
      (prevIndex) => (prevIndex - itemPerPage + featuredProducts.length) % featuredProducts.length
    );
  };
                  ...
                  <div className=" bg-opacity-10 backdrop-blur-sm rounded-lg shadow-lg overflow-hidden h-full transition-all duration-300 hover:shadow-xl border border-emerald-500/30">
                    ...
                    <div className="p-4">
                      ...
                      <Button
                        ...
                        className="w-full bg-emerald-600 cursor-pointer hover:bg-emerald-500 text-white font-semibold py-2 px-4 rounded transition-colors duration-300 
